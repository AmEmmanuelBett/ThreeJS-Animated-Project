...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.setPath('./resources/oldman/');
    loader.load('The_Boss.fbx', (fbx) => {
...
class MyWorld {
  ...
  _Initialize() {
    ...
    this._camera.position.set(100, 40, 0);
    ...
    box1.position.set(0, 30, -50);
    box1.castShadow = true;
    box1.receiveShadow = true;
    this._scene.add(box1);
    const box2 = new THREE.Mesh(
      new THREE.BoxGeometry(50, 30, 0),
      new THREE.MeshStandardMaterial({

      }));
    box2.position.set(0, 30, 50);
